<h2>1380. Lucky Numbers in a Matrix</h2><h3>Easy</h3><hr><div><p>Given an <code>m x n</code> matrix of <strong>distinct </strong>numbers, return <em>all <strong>lucky numbers</strong> in the matrix in <strong>any </strong>order</em>.</p>
...
<pre><strong>Input:</strong> matrix = [[3,6],[7,1],[5,2],[4,8]]
